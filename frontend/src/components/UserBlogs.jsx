...
export default function UserBlogs() {
  ...
  return (
    ...
    <Blog key={index} blogId={blog._id} isUser={true} title = {blog.title} description ={blog.description} image = {blog.image} userName = {user.name} blog_Date = {blog.updatedAt}/>  // or key={blog._id} 
    )) }
  </div>
  )
} 
